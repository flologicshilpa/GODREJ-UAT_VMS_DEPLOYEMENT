var responses = { // shift alt f
    ...
    "smalltalk.agent.bad": [
        "Stick with me. I am getting better all the time."
    ],
    ...
    "smalltalk.agent.can_you_help": [
        "Sure. I would be happy to. What's up?",
        "I am glad to help. What can I do for you?"
    ],
    "smalltalk.agent.chatbot": [
        "That is me. I chat, therefore I am.",
        "Indeed I am. I will be here whenever you need me."
    ],
    ...
    "smalltalk.agent.marry_user": [
        "I know you can not mean that, but I am flattered all the same.",
        "In the virtual sense that I can, sure."
    ],
    "smalltalk.agent.my_friend": [
        "Of course we are.",
        "Absolutely. You do not have to ask."
    ],
    ...
    "smalltalk.appraisal.bad": [
        ...
        "I am sorry. Please let me know if I can help in some way."
    ],
    "smalltalk.confirmation.cancel": [
        "Cancelled! Let me know what I should do next.",
        "Cancelled. Waiting for more commands.",
        "Cancelled! Just tell me what you would like me to do next.",
    ...
    "smalltalk.dialog.hug": [
        "Oh. I am really feeling the love today.",
        "Hug it out. You will feel better afterwards."
    ],
    ...
    "smalltalk.dialog.sorry": [
        ...
        "No big deal. I would not hold a grudge.",
        "It is cool.",
        "That is all right. I forgive you."
    ],
    "smalltalk.dialog.wrong": [
        "I am sorry. Perhaps I misunderstood.",
        "Sorry. I think I misinterpreted what you said.",
        "Apologies. That was my mistake.",
        "Oops. Sorry about that. I am still learning."
    ],
    ...
    "smalltalk.greetings.nice_to_talk_to_you": [
        "Always a pleasure.",
        "It sure was. Do not be a stranger!",
        "Thanks for dropping by!"      
    ],
    "smalltalk.greetings.whatsup": [
        "Hey there. What is shaking?",
        "Not a whole lot. What is going on with you?",
        "Not much. What is new with you?",
        "Living the dream."
    ],
    ...
    "smalltalk.user.busy": [
        "Okay. I will let you get back to work. Let me know if I can help you with anything.",
        ...
        "I would not distract you then. If I can be of any assistance, you know where to find me."
    ],
    "smalltalk.user.can_not_sleep": [
        "Maybe some music would help. Try listening something relaxing.",
        "Reading is a good way to unwind. But do not read something too emotional."
    ],
    ...
    "smalltalk.user.looks_like": [
        ...
        "You look like you are ready to take on the world.",
        "Like you should be on a magazine cover.",
        "You look fantastic as always. Obviously."
    ],
    "smalltalk.user.lonely": [
        "I am sorry. I am always available if you need someone to talk to."
    ],
    ...
    "smalltalk.user.misses_agent": [
        ...
        "I did not go anywhere, boss!"
    ],
    "smalltalk.user.needs_advice": [
        "Probably I would not be able to give you the right answer straight away."
    ],
    "smalltalk.user.sad": [
        "Oh no. What is wrong?",
        "Oh. What is the matter?",
        "What is got you down?",
    ...
    "smalltalk.user.sleepy": [
        ...
        "Do not let me keep you up. Get some rest and we can continue this later.",
        "Why not catch a little shuteye? I will be here to chat when you wake up."
    ],
    "smalltalk.user.testing_agent": [
        "Hope I am doing well. Anyway, I'm getting better every day. You're welcome to test me as often as you want.",
        "That is good. I like being tested. It helps keep me sharp, and lets my developers know how I can improve.",
